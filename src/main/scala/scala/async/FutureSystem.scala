...
trait FutureSystem2 {
  ...
  def mkOps(c: reflect.internal.SymbolTable): Ops { val universe: c.type }
}


object ScalaConcurrentFutureSystem2 extends FutureSystem2 {
 ...
 * on the current thread. Useful for testing.
 */
object IdentityFutureSystem2 extends FutureSystem2 {
